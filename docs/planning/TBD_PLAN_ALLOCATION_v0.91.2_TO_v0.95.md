...
- `ADL_AND_WILDCLAW.md`: useful external-benchmark pressure test, but no
  ...
  interpretation.
- `ADL_LOGISTIC_SPLIT.md`: now has a tracked post-`v0.95` repository split
  plan at `docs/planning/POST_V095_ADL_CSM_LOGISTIC_SPLIT_PLAN.md`, but
