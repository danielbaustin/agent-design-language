# ADR 0027 Candidate: Governed Code Modernization With Moderne/OpenRewrite LST

- Status: Candidate
- Target milestone: v0.91.2
- Related issue: #3124
- Related ADRs: ADR 0020, ADR 0021, ADR 0025 after acceptance
...
This candidate should be reviewed against the modernization feature doc,
