# ADR 0020 Candidate: Universal Tool Schema As Portable Tool Description Standard

- Status: Candidate
- Target milestone: v0.91.2
- Related issues: #3076, #3104, #3107, #3108, #3124
- Related ADRs: supersedes the active UTS interpretation in ADR 0015 after acceptance
