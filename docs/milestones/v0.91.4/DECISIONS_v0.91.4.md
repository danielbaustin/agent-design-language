...
| D-10 | v0.91.4 is go for release after WP-21 merge. | accepted | Sprint 4 review, remediation, next-milestone planning/review, and closeout-normalization evidence have landed or are recorded in the WP-21 ceremony packet. | Keep v0.91.4 open until v0.91.5 bridge work completes. | v0.91.5 bridge work remains routed forward; v0.91.4 may tag and publish from clean `main` after WP-21 merges. | [RELEASE_READINESS](RELEASE_READINESS_v0.91.4.md), [RELEASE_EVIDENCE](RELEASE_EVIDENCE_v0.91.4.md) |
