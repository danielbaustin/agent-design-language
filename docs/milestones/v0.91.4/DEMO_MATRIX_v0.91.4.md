...
| D4 | Software Development Polis actor standing | WP-05 records explicit roles, standing, authority boundaries, and proof duties. | WP-owned actor-standing fixture | actor-standing fixture and authority-boundary report | participants have explicit standing and duties | fixture-based, replayable | planned |
| D5 | Shard ownership and interface freeze | WP-05 proves parallel shards have write boundaries and synchronization barriers. | WP-owned shard fixture | shard ownership fixture and conflict report | conflicts are blocked or routed | fixture-based, replayable | planned |
| D6 | Evidence convergence and review synthesis | WP-06 converges transition evidence, review findings, and residual risks. | WP-owned evidence command | evidence bundle and synthesis output | proof packet contains evidence, findings, and residual risks | replayable from tracked evidence | planned |
| D7 | Merge-readiness and PR gate hardening | WP-07 preserves issue, branch, CI, review, evidence, trace, and closeout truth. | WP-owned merge-readiness check | merge-readiness gate fixture/report | gate refuses stale or missing truth | fixture/snapshot-based | planned |
| D8 | ObsMem handoff validation | WP-08 feeds SRP review results and SOR outcome truth into memory handoff boundary. | WP-owned memory handoff check | memory handoff fixture/report | handoff cites tracked SRP/SOR truth | replayable from tracked records | planned |
...
| D10 | Signed trace proof | WP-06 emits and verifies tracked trace/digest/signature evidence. | WP-owned trace verification command | signed trace bundle plus verification report | signature/digest verification passes | replayable from tracked trace bundle | planned |
