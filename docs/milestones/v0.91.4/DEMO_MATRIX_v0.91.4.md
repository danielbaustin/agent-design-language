...
| D13 | Active issue migration policy | WP-11 classifies active issues into migrate, defer, leave, fold, or block. | Documentary migration audit review via `docs/milestones/v0.91.4/ACTIVE_ISSUE_MIGRATION_AUDIT_2026-05-27.md` | sampled migration audit | sample classifications are explicit and reviewable | audit is reproducible from issue/card state | planned |
