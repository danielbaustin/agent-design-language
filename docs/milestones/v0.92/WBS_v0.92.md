...
| WP-02 | CI and coverage reliability | Repair fast/slow routing, coverage aggregation, platform parity, and immediate-failure causes before broad execution. | Green proving substrate with focused and slow lanes separated. | WP-01. |
...
| WP-24 | Medium launch article | Author a substantive, release-grounded ADL launch article; do not restore the removed empty placeholder. | Reviewed article source and publication disposition. | WP-23. |
| WP-25 | Internal review | Run internal code/docs/tests/process review. | Internal review report and finding register. | WP-23, WP-24. |
