...
| WP-24 | Medium launch article | Draft the substantive ADL launch article early, maintain it as milestone evidence lands, and finalize its claims during WP-23. | Early reviewable article draft plus final release-grounded publication disposition. | WP-01A for the initial draft; WP-23 for final release-truth alignment. |
