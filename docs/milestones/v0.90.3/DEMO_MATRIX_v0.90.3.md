...
| D10 | Standing, communication, and access boundary | WP-11 / WP-12 | Guests and service actors cannot silently acquire citizen rights or inspection access | `STANDING_COMMUNICATION_BOUNDARY_v0.90.3.md`, standing policy, standing events, communication examples, standing negative cases; WP-12 access-denial events pending | PARTIAL: WP-11 LANDED; WP-12 PLANNED |
