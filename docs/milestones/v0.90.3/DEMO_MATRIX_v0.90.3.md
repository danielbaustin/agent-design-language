...
Live milestone matrix. The v0.90.3 issue wave is open as #2327-#2347,
with the explicit demo matrix and feature proof lane at WP-14A / #2341 now
landed as `FEATURE_PROOF_COVERAGE_v0.90.3.md`.
...
| D3 | Signed envelope and trust-root negative cases | WP-04 | Missing, unknown, revoked, mismatched, regressed, and broken-predecessor states are rejected | `SIGNED_PRIVATE_STATE_ENVELOPE_v0.90.3.md`, envelope fixture, trust-root fixture, negative tests | LANDED |
| D4 | Local sealed quintessence checkpoint | WP-05 | Private checkpoint can be sealed locally without making cloud enclaves mandatory | `LOCAL_PRIVATE_STATE_SEALING_v0.90.3.md`, sealed checkpoint fixture, key policy, open/decrypt refusal cases | LANDED |
| D5 | Append-only lineage replay | WP-06 | Current state is accepted only when it matches append-only lineage | `APPEND_ONLY_LINEAGE_LEDGER_v0.90.3.md`, ledger fixture, accepted head calculation, tamper/truncation tests | LANDED |
| D6 | Continuity witness and citizen receipt | WP-07 | Admission, snapshot, wake, and quarantine transitions produce explainable continuity evidence | `CONTINUITY_WITNESSES_AND_RECEIPTS_v0.90.3.md`, witness schema, receipt schema, sample receipt | LANDED |
...
| D12 | Inhabited CSM Observatory flagship | WP-14 | Reviewer can inspect one bounded end-to-end citizen-state scenario through World / Reality, Operator / Governance, optional bounded Cognition / Internal State, and Corporate Investor fallback surfaces | `OBSERVATORY_FLAGSHIP_DEMO_v0.90.3.md`, `OBSERVATORY_UI_ARCHITECTURE_v0.90.3.md`, `runtime_v2/observatory/flagship_proof_packet.json`, witness, receipt, redacted projection, access event, challenge/quarantine artifact, operator report | LANDED |
| D13 | Feature proof coverage record | WP-14A | Every v0.90.3 feature claim has a runnable demo, proof packet, fixture-backed artifact, non-proving status, or explicit deferral | `FEATURE_PROOF_COVERAGE_v0.90.3.md`, `runtime_v2/feature_proof_coverage/feature_proof_coverage.json`, and this demo matrix update | LANDED |
...
WP-14A / D13 keeps every feature proof row mapped to proof, fixture, runnable
command, non-proving status, or explicit deferral in
`FEATURE_PROOF_COVERAGE_v0.90.3.md` and the runtime packet emitted by
