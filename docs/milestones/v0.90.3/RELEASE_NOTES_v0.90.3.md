...
- sanctuary and quarantine behavior for ambiguous continuity
- redacted Observatory projections
- explicit citizen, guest, standing, service actor, and naked-actor boundaries
- access-control and projection policy
...
- v0.90.3 does not complete migration or birthday scope.
- v0.90.3 does not implement full economics or contract markets.
