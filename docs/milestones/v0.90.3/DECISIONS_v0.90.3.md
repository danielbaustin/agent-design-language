...
| D-13 | Conflicting signed successors cannot both become active | Accepted in WP-08 | WP-08 lands a conflict fixture, activation refusal, sanctuary/quarantine disposition, and negative cases proving that two distinct signed successor claims for the same citizen lineage, predecessor, and sequence must preserve evidence instead of activating both heads. |
