...
|---|---|---|
| `AEE_CONVERGENCE_MODEL.md` | promoted | `v0.89 / WP-02` |
| `FREEDOM_GATE_V2.md` | promoted | `v0.89 / WP-03` |
| `DECISION_SURFACES.md` | promoted | `v0.89 / WP-04` |
| `DECISION_SCHEMA.md` | promoted | `v0.89 / WP-04` |
| `ACTION_MEDIATION_LAYER.md` | promoted | `v0.89 / WP-05` |
| `ACTION_PROPOSAL_SCHEMA.md` | promoted | `v0.89 / WP-05` |
| `SKILL_MODEL.md` | promoted | `v0.89 / WP-06` |
| `SKILL_EXECUTION_PROTOCOL.md` | promoted | `v0.89 / WP-06` |
| `GODEL_EXPERIMENT_SYSTEM.md` | promoted | `v0.89 / WP-07` |
| `OBSMEM_EVIDENCE_AND_RANKING.md` | promoted | `v0.89 / WP-08` |
...
| Local source doc | Disposition | Implementation home |
|---|---|---|
| `ADL_ADVERSARIAL_RUNTIME_MODEL.md` | carry forward | `v0.89.1` |
| `ADL_ADVERSARIAL_DEMO.md` | carry forward | `v0.89.1` |
| `ADL_SECURITY_DEMOS.md` | carry forward | `v0.89.1` |
| `ADVERSARIAL_EXECUTION_RUNNER.md` | carry forward | `v0.89.1` |
| `ADVERSARIAL_REPLAY_MANIFEST.md` | carry forward | `v0.89.1` |
| `CONTINUOUS_VERIFICATION_AND_EXPLOIT_GENERATION.md` | carry forward | `v0.89.1` |
| `EXPLOIT_ARTIFACT_SCHEMA.md` | carry forward | `v0.89.1` |
| `PROVIDER_SECURITY_CAPABILITIES_EXTENSION.md` | carry forward | `v0.89.1` |
| `RED_BLUE_AGENT_ARCHITECTURE.md` | carry forward | `v0.89.1` |
| `SELF_ATTACKING_SYSTEMS.md` | carry forward | `v0.89.1` |
