...
| D11 | Governed Tools v1.0 flagship demo | WP-18 | Reviewer can watch proposal, validation, ACC, policy, gate, execution or denial, trace, and redaction end to end in one coherent governed-tools story | flagship proof packet and reviewer/public reports plus four named case artifacts; not blocked on full v0.91 model comparison | LANDED |
