...
This document is the tracked index for the promoted `v0.86` feature-defining docs.

`#1081` promotes the substantive bounded-cognitive-system feature docs into a reviewable tracked home under `docs/milestones/v0.86/features/`.

The goal is to preserve rich planning content while giving the milestone a git-backed feature-doc surface.

## Promoted Feature Docs
