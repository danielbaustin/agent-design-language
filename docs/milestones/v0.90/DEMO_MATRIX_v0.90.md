...
| D4 | Stock league long-lived demo | A bounded demo can show recurring supervised cycles safely | `cargo run --manifest-path adl/Cargo.toml -- demo demo-i-v090-stock-league-scaffold --run --trace --out out --no-open` for the scaffold; recurring integration remains `#2027` | fixture-backed stock league scaffold proof packet; recurring cycle packet pending WP-08 | scaffolded by `#2026` |
