...
- Closed issues: `348`
- Open issues: `0`
- Actual session elapsed explicit: `49`
- Actual session elapsed derived from SOR execution window: `275`
- Actual session elapsed unknown: `24`
- GitHub cycle time reconstructed from created/closed timestamps: `348`
...
- Open-issue local-timing-only rows: `none`
