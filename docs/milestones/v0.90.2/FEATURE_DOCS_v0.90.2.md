...
| `CSM_RUN_PACKET_CONTRACT_v0.90.2.md` | D2/D3/D4 contract gate for the code-backed CSM run packet, fixture definition, invariant map, violation schema, boot/admission artifacts, resource-pressure scheduling artifacts, Freedom Gate mediation artifacts, stage spine, and review target | WP-03 #2247, WP-04 #2248, WP-05 #2249, WP-06 #2250, WP-07 #2251 |
