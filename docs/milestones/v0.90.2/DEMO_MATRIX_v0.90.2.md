...
| D2 | CSM run packet fixture | WP-03 #2247 / WP-04 #2248 | The first CSM run has a stable packet and invariant/violation contract before coding widens | `CSM_RUN_PACKET_CONTRACT_v0.90.2.md`, CSM run fixture, invariant map, violation schema | PARTIAL: WP-03 CONTRACT LANDED |
