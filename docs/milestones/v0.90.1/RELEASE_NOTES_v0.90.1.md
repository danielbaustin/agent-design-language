...
- v0.90.1 does not birth the first true Gödel agent.
- v0.90.1 does not complete the moral/emotional civilization layer.
- v0.90.1 does not complete identity/capability rebinding.
- v0.90.1 does not complete cross-polis migration.
- v0.90.1 does not ship the full red/blue/purple security ecology.
- v0.90.1 does not treat compression as permission to skip review or release
  evidence.
