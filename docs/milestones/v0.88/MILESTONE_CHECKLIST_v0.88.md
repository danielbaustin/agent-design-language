...
Ship / no-ship gate for `v0.88`.

This milestone must prove a real temporal / PHI / instinct package with runnable demos and reviewable artifacts, not just coherent planning language.

## Planning
- [x] Milestone goal defined (`docs/milestones/v0.88/VISION_v0.88.md`)
- [x] Scope and non-goals documented (`docs/milestones/v0.88/DESIGN_v0.88.md`)
- [x] Feature-doc package promoted and indexed (`docs/milestones/v0.88/FEATURE_DOCS_v0.88.md`)
- [x] WBS created and mapped to the intended milestone shape (`docs/milestones/v0.88/WBS_v0.88.md`)
- [x] Decision log initialized and reconciled (`docs/milestones/v0.88/DECISIONS_v0.88.md`)
...
- [x] Historical / exploratory local planning notes kept out of tracked public scope
...
## Exit Criteria
- the temporal / PHI / instinct package is proven through demos and artifacts
- docs and implementation agree on the same bounded milestone
- review findings are resolved or explicitly deferred
- next milestone planning is prepared before release ceremony
- the milestone is ready to hand off cleanly
