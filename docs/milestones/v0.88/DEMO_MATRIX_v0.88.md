...
`v0.88` is still in planning / issue-seeding state, so this matrix records the intended proof rows rather than completed commands.

## Planned Proof Rows

| Demo ID | Focus | Proof surface | Planned artifact | Status |
|---|---|---|---|---|
| D1 | temporal schema and anchors | trace/schema review plus fixture-driven proof | schema review artifact | planned |
