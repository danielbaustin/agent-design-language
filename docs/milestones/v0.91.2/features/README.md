...
| General intelligence paper | [GENERAL_INTELLIGENCE_PAPER_PACKET.md](GENERAL_INTELLIGENCE_PAPER_PACKET.md) | `.adl/docs/TBD/general-intelligence-paper/`; separate `general-intelligence-paper` repo; `docs/milestones/v0.91.2/review/general_intelligence_paper/` | WP-14 | claim, citation, review, residual-risk register, and next authoring steps |
