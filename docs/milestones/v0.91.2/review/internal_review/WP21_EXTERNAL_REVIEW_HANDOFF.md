...
- UTS benchmark methodology and evidence boundaries
- provider-native comparison non-claims
- GWS bridge live-safety and authority boundaries
- CodeFriend/review-product packet usefulness
- Moderne/OpenRewrite bounded modernization evidence
...
- release readiness
- broad provider/model conformance
- production external-tool execution safety
- Workspace as canonical repo truth
