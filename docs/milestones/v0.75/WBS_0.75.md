...
| WP-13 | Demo matrix + integration demos | Author and validate v0.75 demo packs (Determinism+Replay; Ingest+Query; Operational report). Ensure commands run from docs on a fresh checkout. | `docs/milestones/v0.75/DEMO_MATRIX.md` + runnable examples. | WP-03, WP-06, WP-12 | TBD |
