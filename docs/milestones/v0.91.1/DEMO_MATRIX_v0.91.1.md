...
| Observatory-visible agent flagship demo | WP-16 | Show an agent-shaped run inside the CSM boundary with operator projection. | `adl runtime-v2 observatory-flagship-demo --out artifacts/v0911/demo-d12-observatory-flagship`, `adl/src/runtime_v2/observatory_flagship.rs`, and the tracked review bundle under `docs/milestones/v0.91.1/review/observatory_flagship_demo/` | does not claim birthday, personhood, raw private-state inspection, or autonomous federation |
