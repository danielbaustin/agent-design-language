...
- SEP/VPP/PVF/template/session-ledger/workflow-adoption work must make sprint execution predictable rather than chat-memory driven, with `#4388`-`#4398` plus late inputs `#4405`, `#4412`-`#4413`, `#4417`-`#4425`, and `#4433`-`#4438` serving as the v0.91.6 completion stream for the integrated control plane.
