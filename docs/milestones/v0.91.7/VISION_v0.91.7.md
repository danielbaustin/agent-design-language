...
`v0.91.7` moves ADL from first-tranche bridge readiness into residual bridge
closure. It does not implement runtime behavior and does not approve `v0.92`
...
1. Make every second-tranche residual visible as a tracked feature doc.
2. Prevent `v0.92` from absorbing unresolved conceptual work silently.
3. Preserve security and ACIP/A2A residuals on the activation path.
