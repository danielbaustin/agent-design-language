...
| WP-13 parent closeout | `#4640`, `docs/milestones/v0.91.7/review/wp13_closeout_4640.md` | WP-13 closes only as the reconciliation of closed child issues `#4752`-`#4757`; v0.92 consumption remains bounded by each child packet and the parent closeout non-claims. |
