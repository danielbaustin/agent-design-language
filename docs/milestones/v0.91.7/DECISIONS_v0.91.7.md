...
Capture significant second-tranche bridge decisions and open questions.

## Decision Log

| ID | Decision | Status | Rationale | Impact | Link |
| --- | --- | --- | --- | --- | --- |
| D-01 | Treat `v0.91.7` as required pre-`v0.92` bridge work. | accepted | The residual surfaces are too important to leave to activation rediscovery. | Creates tracked docs before `#3780` proceeds. | `#3825` |
...
- Which ACIP residuals must be closed before `v0.92`, and which may defer?
- Which security residuals move to `v0.93` enterprise security?
