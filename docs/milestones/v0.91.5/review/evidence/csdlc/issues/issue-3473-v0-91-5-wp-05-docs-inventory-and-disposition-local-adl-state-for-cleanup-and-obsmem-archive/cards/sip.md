...
Context:
- Issue: https://github.com/danielbaustin/agent-design-language/issues/3473
- PR:
- Source Issue Prompt: .adl/v0.91.5/bodies/issue-3473-v0-91-5-wp-05-docs-inventory-and-disposition-local-adl-state-for-cleanup-and-obsmem-archive.md
- Docs: none
- Other: none
...
outputs:
  output_card: .adl/v0.91.5/tasks/issue-3473__v0-91-5-wp-05-docs-inventory-and-disposition-local-adl-state-for-cleanup-and-obsmem-archive/sor.md
...
- Tools allowed:
- Sandbox / approvals:
- Source issue-prompt slug: v0-91-5-wp-05-docs-inventory-and-disposition-local-adl-state-for-cleanup-and-obsmem-archive
