...
| --- | --- | --- | --- | --- |
| Cognitive Transition manifest validation | WP-02 | Show a transition manifest links issue, actor roles, cards, DAG, evidence, gate, and memory. | valid/invalid fixture results | planned |
