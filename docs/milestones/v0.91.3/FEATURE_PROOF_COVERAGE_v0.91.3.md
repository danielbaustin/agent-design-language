...
| Five-minute HTML game sprint demo | `features/FIVE_MINUTE_HTML_GAME_SPRINT_DEMO.md` | `bash adl/tools/demo_v0913_starharvest_html_game.sh` | A bounded C-SDLC creative-production slice yields a runnable visible browser artifact plus proof packet. | bounded artifact and packet proof landed under demo #3221; full browser automation remained partial in the captured environment |
