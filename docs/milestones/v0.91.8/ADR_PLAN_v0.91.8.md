...
| Topic | Owning issue | ADR posture |
| --- | ---: | --- |
| ADL v2 clean-room architecture | #5336 | Required before core implementation closes |
| Runtime v3 authority boundary | #5341, #5361 | Required before adapter/deployment claims |
