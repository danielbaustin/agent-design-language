...
| v0.92 handoff and birthday-prep package | #5362, #5355, #4758, #4759, #4760, #4761, #4762, #4763, #5007, #5107 | `open_gate` | Capability-envelope input exists at `.csdlc/evidence/4761/capability-envelope/envelope.v1.json`; live GitHub truth on 2026-08-04 shows #5362, #5355, #5359, and #5348 as the open downstream umbrella gates. The named preparation children are closed retained inputs. | Handoff and preparation only until release-tail owners close; not v0.92 activation or birthday implementation. |
