# Issue 5866 Design: WP-04.04 Seed discovery and authenticated join

## Outcome And Boundary

Implement bounded seed discovery and authenticated join without making discovery an authority source. This child is one exclusive implementation slice under
...
Implement bounded seed discovery and authenticated join without making discovery an authority source. The implementation must preserve Guardian as process 0,
...
Exact nextest target distributed_discovery proves configured seed discovery, authenticated join, duplicate suppression, timeout, stale seed, and wrong-domain refusal.
