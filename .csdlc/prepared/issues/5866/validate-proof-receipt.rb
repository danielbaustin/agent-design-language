...
expected_issue = 5866
expected_wp = "WP-04.04"
expected_paths = ["adl-runtime/src/distributed/discovery.rs","adl-runtime/tests/distributed_discovery.rs"]
expected_test = "distributed_discovery"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5866/execution-proof.json")
