...
expected_issue = 5871
expected_wp = "WP-04.09"
expected_paths = ["adl-runtime/src/distributed/capability_advertisement.rs","adl-runtime/tests/distributed_capability_advertisement.rs"]
expected_test = "distributed_capability_advertisement"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5871/execution-proof.json")
