...
expected_issue = 5868
expected_wp = "WP-04.06"
expected_paths = ["adl-runtime/src/distributed/failure_detection.rs","adl-runtime/tests/distributed_failure_detection.rs"]
expected_test = "distributed_failure_detection"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5868/execution-proof.json")
