...
expected_issue = 5872
expected_wp = "WP-04.10"
expected_paths = ["adl-runtime/src/distributed/resource_weather.rs","adl-runtime/tests/distributed_resource_weather.rs"]
expected_test = "distributed_resource_weather"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5872/execution-proof.json")
