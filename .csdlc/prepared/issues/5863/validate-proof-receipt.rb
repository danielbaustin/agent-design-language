...
expected_issue = 5863
expected_wp = "WP-04.01"
expected_paths = ["adl-runtime/src/distributed/identity.rs","adl-runtime/tests/distributed_identity.rs"]
expected_test = "distributed_identity"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5863/execution-proof.json")
