...
expected_issue = 5865
expected_wp = "WP-04.03"
expected_paths = ["adl-runtime/src/distributed/transport.rs","adl-runtime/tests/distributed_transport.rs","adl-runtime/Cargo.toml","adl-runtime/Cargo.lock"]
expected_test = "distributed_transport"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5865/execution-proof.json")
