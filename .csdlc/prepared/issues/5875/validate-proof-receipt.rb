...
expected_issue = 5875
expected_wp = "WP-04.13"
expected_paths = ["adl-runtime/src/distributed/migration.rs","adl-runtime/tests/distributed_migration.rs"]
expected_test = "distributed_migration"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5875/execution-proof.json")
