...
expected_issue = 5877
expected_wp = "WP-04.15"
expected_paths = ["adl-runtime/src/distributed/projection.rs","adl-runtime/tests/distributed_projection.rs","docs/api/runtime-v3/v1/distributed.openapi.json"]
expected_test = "distributed_projection"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5877/execution-proof.json")
