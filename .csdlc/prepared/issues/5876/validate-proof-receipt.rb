...
expected_issue = 5876
expected_wp = "WP-04.14"
expected_paths = ["adl-runtime/src/distributed/recovery.rs","adl-runtime/tests/distributed_recovery.rs"]
expected_test = "distributed_recovery"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5876/execution-proof.json")
