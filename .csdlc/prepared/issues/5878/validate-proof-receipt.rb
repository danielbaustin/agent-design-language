...
expected_issue = 5878
expected_wp = "WP-04.16"
expected_paths = ["adl-runtime/src/distributed/mod.rs","adl-runtime/src/lib.rs","adl-runtime/tests/distributed_guardian.rs","adl/tools/validate_v092_distributed_guardian.sh","adl/tools/validate_v092_distributed_native_receipts.rb"]
expected_test = "distributed_guardian"
required_platforms = ["macos", "linux", "windows"]
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5878/execution-proof.json")
