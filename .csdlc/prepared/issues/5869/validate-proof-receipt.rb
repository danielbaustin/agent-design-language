...
expected_issue = 5869
expected_wp = "WP-04.07"
expected_paths = ["adl-runtime/src/distributed/lease.rs","adl-runtime/tests/distributed_lease.rs"]
expected_test = "distributed_lease"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5869/execution-proof.json")
