...
expected_issue = 5867
expected_wp = "WP-04.05"
expected_paths = ["adl-runtime/src/distributed/membership.rs","adl-runtime/tests/distributed_membership.rs"]
expected_test = "distributed_membership"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5867/execution-proof.json")
