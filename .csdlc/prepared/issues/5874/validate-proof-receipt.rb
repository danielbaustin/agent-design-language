...
expected_issue = 5874
expected_wp = "WP-04.12"
expected_paths = ["adl-runtime/src/distributed/snapshot_catalog.rs","adl-runtime/tests/distributed_snapshot_catalog.rs"]
expected_test = "distributed_snapshot_catalog"
required_platforms = []
