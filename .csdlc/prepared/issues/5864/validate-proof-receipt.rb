...
expected_issue = 5864
expected_wp = "WP-04.02"
expected_paths = ["adl-runtime/src/distributed/certificates.rs","adl-runtime/tests/distributed_certificates.rs"]
expected_test = "distributed_certificates"
required_platforms = []
evidence_path = ARGV.fetch(0, ".csdlc/evidence/5864/execution-proof.json")
