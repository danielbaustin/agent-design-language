...
Prepare #4758 for later execution and stop before launch readiness implementation.
...
3. AC-3: the future launch readiness artifact must be integrated into the v0.91.8 pre-v0.92 path
...
- launch readiness implementation during preparation
