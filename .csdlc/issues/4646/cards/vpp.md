...
Design: .csdlc/prepared/issues/4646/design.md

Diagram: .csdlc/prepared/issues/4646/diagram.mmd
...
- `/Users/daniel/git/agent-design-language/.adl/bin/csdlc-v2/csdlc-doctor --repo . --issue 4646`
- `git diff --check`
