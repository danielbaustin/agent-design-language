...
Design: .csdlc/prepared/issues/4647/design.md

Diagram: .csdlc/prepared/issues/4647/diagram.mmd
...
- `/Users/daniel/git/agent-design-language/.adl/bin/csdlc-v2/csdlc-doctor --repo . --issue 4647`
- `git diff --check`
