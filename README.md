...
ADL treats this as the Mythos problem: if increasingly capable
vulnerability-finding systems keep compressing the cost of exploit discovery,
serious agent platforms cannot rely only on occasional audits or after-the-fact
explanations. They need runtime-visible ways to find, replay, and repair their
own weaknesses before those weaknesses become durable operational risk.
