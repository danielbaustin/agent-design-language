...
Context:
- Issue: https://github.com/danielbaustin/agent-design-language/issues/1679
- PR:
- Source Issue Prompt: .adl/v0.88/bodies/issue-1679-make-workflow-conductor-derive-live-routing-state-and-prove-real-repo-handoffs.md
- Docs: none
- Other: none
...
outputs:
  output_card: .adl/v0.88/tasks/issue-1679__make-workflow-conductor-derive-live-routing-state-and-prove-real-repo-handoffs/sor.md
