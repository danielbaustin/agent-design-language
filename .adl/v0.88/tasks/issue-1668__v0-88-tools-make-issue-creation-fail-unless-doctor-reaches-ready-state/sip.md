...
Context:
- Issue: https://github.com/danielbaustin/agent-design-language/issues/1668
- PR:
- Source Issue Prompt: .adl/v0.88/bodies/issue-1668-v0-88-tools-make-issue-creation-fail-unless-doctor-reaches-ready-state.md
- Docs: none
- Other: none
...
outputs:
  output_card: .adl/v0.88/tasks/issue-1668__v0-88-tools-make-issue-creation-fail-unless-doctor-reaches-ready-state/sor.md
