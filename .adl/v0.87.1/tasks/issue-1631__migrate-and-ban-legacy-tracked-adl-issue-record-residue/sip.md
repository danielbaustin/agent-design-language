...
Context:
- Issue: https://github.com/danielbaustin/agent-design-language/issues/1631
- PR:
- Source Issue Prompt: .adl/v0.87.1/bodies/issue-1631-migrate-and-ban-legacy-tracked-adl-issue-record-residue.md
- Docs: none
- Other: none
...
outputs:
  output_card: .adl/v0.87.1/tasks/issue-1631__migrate-and-ban-legacy-tracked-adl-issue-record-residue/sor.md
