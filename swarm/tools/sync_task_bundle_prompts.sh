...
usage() {
  cat <<'EOF'
Usage: swarm/tools/sync_task_bundle_prompts.sh [--root <repo-root>] [--scope <scope>]
...
Use swarm/tools/sync_task_bundle_prompts.sh to refresh this canonical local view
