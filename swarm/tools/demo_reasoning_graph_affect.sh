...
"$ROOT/swarm/tools/demo_affect_engine.sh" "$OUT_ROOT"

echo "[reasoning-graph-demo] initial reasoning graph artifact:"
cat "$ROOT/.adl/runs/v0-3-aee-recovery-initial/learning/reasoning_graph.v1.json"

echo "[reasoning-graph-demo] adapted reasoning graph artifact:"
cat "$ROOT/.adl/runs/v0-3-aee-recovery-adapted/learning/reasoning_graph.v1.json"
