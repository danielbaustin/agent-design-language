...
```bash
cargo run --manifest-path adl/Cargo.toml -- adl/examples/v0-3-on-error-retry.adl.yaml --print-plan
cargo run --manifest-path adl/Cargo.toml -- adl/examples/v0-3-on-error-retry.adl.yaml --run
```
