...
use self::obsmem::{
    query_obsmem_retrieval_demo, run_godel_stage_loop_demo, seed_obsmem_retrieval_demo,
    DEMO_D_FAILURE_SIGNAL_JSON, DEMO_D_README_MD, DEMO_F_README_MD,
};
use self::pipeline::{
            ...
            DEMO_G_V086_CONTROL_PATH => match *step_id {
                ...
                "summarize" => {
                    artifacts.push(write_file(
                        out_dir,
                        "README.md",
                        include_str!("demo/fixtures/demo_g_readme.md"),
                    )?);
                }
                _ => {}
            },
