...
fn run_with_dispatch(
    ...
    pr_dispatch_support::run_pr_subcommand_args("preflight", USAGE, args, dispatch)
}
...
mod tests {
    ...
    #[test]
    fn adl_pr_preflight_help_and_version_paths_succeed() {
    ...
    #[test]
    fn adl_pr_preflight_forwards_args_to_dispatch() {
