...
const USAGE: &str = "adl-pr-inventory - ADL direct PR inventory binary\n\n\
Usage:\n\
  adl-pr-inventory [-R owner/repo] [--json]\n\
  adl-pr-inventory --help\n\
  adl-pr-inventory --version";

fn run_with_dispatch(
    args: &[String],
    dispatch: fn(&[String]) -> anyhow::Result<()>,
) -> anyhow::Result<()> {
    pr_dispatch_support::run_pr_subcommand_args("pr-inventory", USAGE, args, dispatch)
}
...
mod tests {
    ...
    #[test]
    fn adl_pr_inventory_help_and_version_paths_succeed() {
    ...
    #[test]
    fn adl_pr_inventory_forwards_args_to_dispatch() {
        ...
        assert_eq!(
            ...
            &vec!["pr-inventory".to_string(), "--json".to_string()]
        );
    }
}
