...
fn run_with_dispatch(
    ...
    pr_dispatch_support::run_pr_subcommand_args("ready", USAGE, args, dispatch)
}
...
mod tests {
    ...
    #[test]
    fn adl_pr_ready_help_and_version_paths_succeed() {
    ...
    #[test]
    fn adl_pr_ready_forwards_args_to_dispatch() {
        ...
        assert_eq!(
            ...
            &vec!["ready".to_string(), "123".to_string(), "--json".to_string()]
        );
    }
}
