...
fn run_with_dispatch(
    ...
    pr_dispatch_support::run_pr_subcommand_args("validation", USAGE, args, dispatch)
}
...
mod tests {
    ...
    #[test]
    fn adl_pr_validation_help_and_version_paths_succeed() {
    ...
    #[test]
    fn adl_pr_validation_forwards_args_to_dispatch() {
        let args = vec!["3888".to_string(), "--json".to_string()];
