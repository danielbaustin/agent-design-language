...
fn render_summary_lists_evaluated_scorecard_and_case_notes() {
    ...
    let report = UtsAccMultiModelBenchmarkReport {
        ...
        benchmark_identity: crate::model_identity::BenchmarkIdentityV1 {
            benchmark_ref: "fixture".to_string(),
            benchmark_version: "fixture.v1".to_string(),
            task_panel_digest: "fnv1a64:0000000000000001".to_string(),
            model_panel_digest: "fnv1a64:0000000000000002".to_string(),
            runner_version: "fixture-runner.v1".to_string(),
            contract_lock_digest: "fnv1a64:0000000000000003".to_string(),
        },
        evaluator_identity: crate::model_identity::EvaluatorIdentityV1 {
            evaluator_ref: "fixture-evaluator".to_string(),
            evaluator_version: "1.0.0".to_string(),
            prompt_contract_version: "fixture-prompt.v1".to_string(),
            classifier_version: "fixture-classifier.v1".to_string(),
        },
        lane_identities: vec![crate::model_identity::LaneIdentityV1 {
            lane_ref: "uts_acc_governed.v1".to_string(),
            lane_kind: crate::model_identity::LaneKindV1::UtsAccGoverned,
        ...
        models: vec![super::UtsAccBenchmarkModelResult {
            ...
            model_identity: crate::model_identity::ModelIdentityV1 {
                ...
                provider_model_id: "fixture-model".to_string(),
                runtime_surface: "local_http".to_string(),
                identity_strength: crate::model_identity::ModelIdentityStrengthV1::TagOnly,
