...
fn runtime_v2_csm_observatory_contract_matches_golden_fixtures() {
    ...
    assert_eq!(
        ...
        include_str!("../../tests/fixtures/runtime_v2/observatory/operator_report.md").trim_end()
    );
}
...
fn runtime_v2_csm_recovery_eligibility_contract_matches_golden_fixtures() {
    ...
    assert_eq!(
        model,
        include_str!("../../tests/fixtures/runtime_v2/recovery/eligibility_model.json").trim_end()
    );
    assert_eq!(
        safe_resume,
    ...
    assert_eq!(
        quarantine_required,
        include_str!("../../tests/fixtures/runtime_v2/recovery/quarantine_required_decision.json")
            .trim_end()
    );
}
...
fn runtime_v2_csm_hardening_contract_matches_golden_fixtures() {
    ...
    assert_eq!(
        duplicate,
        include_str!("../../tests/fixtures/runtime_v2/hardening/duplicate_activation_probe.json")
            .trim_end()
    );
    assert_eq!(
        snapshot,
