...
PR_SH="${PR_SH:-adl/tools/pr.sh}"
CODEXW_SH="${CODEXW_SH:-adl/tools/codexw.sh}"
...
usage() {
  cat <<'USAGE' >&2
Usage:
  adl/tools/codex_pr.sh <input-card> --paths "<p1,p2,...>" [--mode full-auto|auto-edit|suggest|help] [--slug <slug>] [--pr-sh <path>] [--codexw-sh <path>]
