...
usage() {
  cat <<'EOF'
Usage:
  adl/tools/branch_hygiene.sh [--apply] [--include-stale] [--remote-merged]
...
Examples:
  adl/tools/branch_hygiene.sh
  adl/tools/branch_hygiene.sh --apply
  adl/tools/branch_hygiene.sh --apply --include-stale
  adl/tools/branch_hygiene.sh --apply --remote-merged
EOF
}
