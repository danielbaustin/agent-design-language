# Repo Review Docs Skill Input Schema

```yaml
skill_input_schema: repo_review_docs.v1
...
Use this schema when invoking `repo-review-docs` as a bounded documentation specialist in the multi-agent repository review suite. The skill focuses on misleading docs, stale commands, onboarding gaps, release/demo truth drift, API or CLI contract drift, and overclaims.
...
```text
.adl/reviews/<timestamp>-repo-review-docs.md
```
