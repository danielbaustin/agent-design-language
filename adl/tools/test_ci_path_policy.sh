...
EOF
  ...
  assert_has "$cargo_structural_output" "full_coverage_required=true"
  ...
  assert_has "$cargo_structural_output" "fail_closed=true"
  assert_has "$cargo_structural_output" "coverage_lane=authoritative_full"
  assert_has "$cargo_structural_output" "coverage_authority=fail_closed"
  assert_has "$cargo_structural_output" "proof_validation_scope=not_required"
  assert_has "$cargo_structural_output" "reason=validation_manager_escalation_requires_authoritative_full_coverage"
  assert_has "$cargo_structural_output" "validation_profile_selected=validation_none"
  assert_has "$cargo_structural_output" "validation_profile_status=escalation_required"
  assert_has "$cargo_structural_output" "validation_profile_escalation_required=true"
  assert_has "$cargo_structural_output" "validation_profile_escalation_lanes=unmapped_change_surface"
