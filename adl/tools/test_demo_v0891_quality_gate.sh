...
(
  cd "$ROOT_DIR"
  bash adl/tools/demo_v0891_quality_gate.sh "$OUT_DIR" >/dev/null
)
...
if manifest.get("manifest_version") != "adl.v0891.quality_gate.v1":
...
required = {
    ...
    "coverage_gate",
    "demo_smoke",
    "wp13_demo_integration",
    "five_agent_hey_jude",
    "arxiv_manuscript_workflow",
    "rust_module_watch",
}
...
echo "demo_v0891_quality_gate: ok"
